...
Set-Location $fullPhysicalPath;

###############################################################################################

# Respositórios das aplicações no Azure DevOps

# Apol 			 - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/Apol
# Apolcli		 - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/Apol.Consulta
# Portal_webseek - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/Portal_Webseek
# Siteld 		 - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/SiteLD
# Webseek 		 - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/Webseek
# WSeekJuris 	 - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/WSeekJuris

# WebServices 	 - https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/Apol.Net

# Intranet		 - https://ldsoftdesenv.visualstudio.com/LDSoft.Intranet/_git/LDSoft.Intranet-Agrupamento

$gitBasePath = "https://ldsoftdesenv.visualstudio.com/Desenvolvimento/_git/";
...
if (Test-IsGitInstalled -eq $null) {
	Write-Host "";
	Write-Host -foregroundColor Red "Erro: O cliente do Git nao está instalado.";
	return;
}

# Verificar o caso de todos os endereços, o Git é case sensitive
$appsInDev = "Apol", "Apol.Consulta", "Portal_webseek", "Siteld", "webseek", "WSeekJuris";

# TODO: Implementação para outros projetos além do "Desenvolvimento".

###############################################################################################

# Clone repositories in Desenvolvimento
foreach ($app in $appsInDev)
{
	Git clone $gitBasePath$app;
    # Git clone $gitBasePath$app -o <name>;
}
...
$endCheckout = Read-Host "Continue quando a copia das aplicacoes for concluida! [Enter] Para prosseguir";
...
#foreach ($app in $appsInDev)
#	& $svnExePath checkout $gitBasePath$svnRepository$svnBranch$app $fullPhysicalPath$app;
...
#  "WSeekJuris*";
$apps = "Apol*", "Apolcli", "Intranet@", "Portal_webseek", "Siteld", "Webseek*", "WebServices@", "WSeekJuris*";
